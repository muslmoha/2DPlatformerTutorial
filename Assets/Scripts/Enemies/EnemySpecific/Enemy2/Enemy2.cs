...
public class Enemy2 : Entity
{
    ...
    public D_DodgeStateData dodgeStateData; //because we need to access the data from here in a different classe, must be public
    ...
    {
        base.Damage(attackDetails); //we need to put this here because THIS goees on the enemy GameObject, and the damage function needs to be called by other gameobjects
        ...
        else if (!CheckPlayerInMinAgroRange()) //Because the player would hit from behind, so this would be false
        {
            lookForPlayerState.SetTurnImmediately(true); //Thus we need to turn them around immediately
